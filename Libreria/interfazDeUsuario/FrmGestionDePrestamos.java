<<<<<<< Updated upstream:Libreria/interfazDeUsuario/FrmGestionDePrestamos.java
/*
...
public class FrmGestionDePrestamos extends javax.swing.JFrame {
    ...
    private void actualizarDisponibilidad(ArrayList<Object> titulos){
        ArrayList<Object> libros=null;
        try{
            libros=ManejadorArchivos.leerArchivo("Libros.poo");
        }catch(Exception ex){
            
        }
        for(Object nombre:titulos){
            for(Object libro:libros){
                if(((String)nombre).equals(((Libro)libro).getTitulo())){
                    ((Libro)libro).setDisponibilidad(false);
                }
            }
        }
        try{
            for(int i=0; i<libros.size(); i++)
                ManejadorArchivos.reemplazarObjeto("Libros.poo",i,libros.get(i));
        }catch(Exception ex){
            //si
        }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        actualizarDisponibilidad(titulos);
        Contadores.setPrestamos(Contadores.getPrestamos()+titulos.size());
    }//GEN-LAST:event_btnAceptarActionPerformed
    private void validMesYDia(int dia, int mes, int anio) throws InvalidDateFormat {
        if (dia > 31 || dia < 1) {
            throw new InvalidDateFormat("?");
...
>>>>>>> Stashed changes:Libreria/src/libreria/interfazDeUsuario/FrmGestionDePrestamos.java
